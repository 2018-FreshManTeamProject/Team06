...
namespace Team06.Device
{
    class Input
    {
        ...
        /// <returns>現在キーが押されていて、1フレーム前に押されていなければ</returns>
        ...
        /// マウスの左ボタンは押された瞬間か？
        /// </summary>
        /// <returns>現在押されていて、1フレーム前に押されていなければ</returns>
        ...
        /// マウスの左ボタンが離された瞬間か？
        /// </summary>
        /// <returns>現在はなされていて、1フレーム前に押されていたら</returns>
        ...
        /// </summary>
        /// <returns>現在はなされていて、1フレーム前に押されていたら</returns>
        public static bool IsMouseBottonUp()
        {
        ...
        /// </summary>
        /// <returns>左ボタンが押されていたら</returns>
        public static bool IsMouseBotton()
        {
